...
const cartIdtoAdd = document.querySelector('#cartIdtoAdd')
...
const newProductToAdd = {id: productid, cart: parseInt(cartIdtoAdd)}

addToCartButton.addEventListener('click', ()=>{
    socket.emit('addToProduct', newProductToAdd)
})
