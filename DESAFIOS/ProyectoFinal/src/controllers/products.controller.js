...
export class ProductClass {
    ...
    createProdutcs = async (req, res) =>{
        const newProduct = req.body //define el nuevo producto en base a los datos pasados por body
        
        let respuesta = await productService.createProduct(newProduct) //lee los productos en la base de datos
        
        if (!respuesta) { //en caso de que no exista, saltamos alarma. y si no existe ya se gernera
    ...
    updateProduct = async (req, res) =>{
        const updateProduct = req.body //pasamos los datos a modificar por body
